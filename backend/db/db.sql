...
INSERT INTO tb_todo (title, description, deadline, status, fk_user)
    VALUES ('Teste', NULL, '2022-12-07 14:34:05', FALSE, 1);

INSERT INTO tb_todo (title, description, deadline, status, fk_user)
    VALUES ('Teste2', NULL, '2022-12-08 14:34:05', TRUE, 1);

INSERT INTO tb_todo (title, description, deadline, status, fk_user)
    VALUES ('Teste3', NULL, '2022-12-09 14:34:05', FALSE, 1);

/* Add 2 ToDos tb_todo user 2 */
INSERT INTO tb_todo (title, description, deadline, status, fk_user)
    VALUES ('Teste', NULL, '2022-12-07 14:34:05', FALSE, 2);

INSERT INTO tb_todo (title, description, deadline, status, fk_user)
    VALUES ('Teste2', NULL, '2022-12-08 14:34:05', FALSE, 2);